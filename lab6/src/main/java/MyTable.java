...
public class MyTable extends AbstractTableModel implements Serializable{
    /**
...
//
         ...
         * @see #setValueAt
         */
        public MyTable(int rowCount, int columnCount) {
         ...
         * @see #setValueAt
         */
        public MyTable(Vector columnNames, int rowCount) {
         ...
         * @see #setValueAt
         */
        public MyTable(Object[] columnNames, int rowCount) {
         ...
         * @see #setDataVector
         */
        public MyTable(Vector data, Vector columnNames) {
...
//
        ...
        public boolean isCellEditable(int row, int column) {
            if (column == 4 || column == 3)
                return false;
            if (getValueAt(row,4).equals(Methods.name)){
                return true;
            }else return false;
        }
